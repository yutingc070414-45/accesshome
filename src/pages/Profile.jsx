...
export default function Profile() {
  ...
  const [avatar, setAvatar] = useState(
    localStorage.getItem("ah-avatar") || null,
  );
  const [lang, setLangState] = useState(
    localStorage.getItem("ah-lang") || "en",
  );
  const [fontSize, setFontSizeState] = useState(
    localStorage.getItem("ah-fontsize") || "medium",
  );
          ...
          rooms.forEach((room) => {
            ...
            if (type === "curtain")
              fetch(`${API}/api/curtain/update`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ room: room.room, openPercent: 0 }),
              });
          });
        })
        .catch(() => {});
          ...
          <div className="gp-right">
            ...
            <div className="gp-section">
              ...
              <div className="gp-row">
                ...
                <div className="gp-row-right">
                  ...
                  />
                  <button className="gp-save-btn" onClick={saveName}>
                    {t("profile.save")}
                  </button>
                </div>
              </div>
            ...
            <div className="gp-section">
              ...
              <div className="gp-row">
                <div className="gp-row-left">
                  ...
                  <div className="gp-row-desc">
                    {t("profile.displayLangDesc")}
                  </div>
                </div>
                <div className="gp-row-right">
            ...
            <div className="gp-section">
              ...
              <div className="gp-row">
                ...
                <div className="gp-row-right">
                  <button className="profile-danger-btn" onClick={logout}>
                    {t("profile.logout")}
                  </button>
                </div>
              </div>
